...
def get_parser():
    ...
    parser.add_argument("--config",
                        type=str,
                        default="config/psg6d_freeze_world_enhancer.yaml",
...
if __name__ == "__main__":
    ...
    if cfg.model_arch == "psg6d":
        from model.psg6d import PSG6D, SupervisedLoss
        model = PSG6D(cfg.num_category, cfg.freeze_world_enhancer)
    elif cfg.model_arch == "posenet_gt":
        from model.posenet_gt_vnn_glo import PoseNetGT, SupervisedLoss
